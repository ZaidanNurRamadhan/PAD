<!-- resources/vue/components/modals/HapusPemasok.vue -->
<template>
    <div class="modal fade show" id="HapusPemasok" tabindex="-1" style="display: block;">
      <div class="modal-dialog modal-dialog-centered">
        <main class="modal-content d-flex justify-content-center align-items-center">
          <header class="modal-header">
            <h1 class="modal-title fs-5">Hapus Pemasok</h1>
          </header>
    ...
    setup(props, { emit }) {
      ...
      const confirmDelete = async () => {
        try {
          ...
          // Panggil API untuk menghapus pemasok
