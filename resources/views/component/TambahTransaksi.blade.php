            ...
            <form action="{{ route('transaksi.store') }}" method="post">
                ...
                <article class="modal-body">
                    ...
                    <section class="form-group d-flex justify-content-between px-3 mt-4">
                        ...
                        <select name="produk_id" id="produk_id" class="form-control" style="max-width: 273px;" required>
                    ...
                    <section class="form-group d-flex justify-content-between px-3 mt-4">
                        ...
                        <input type="date" name="tanggal_keluar" id="tanggal_keluar" class="form-control" style="max-width: 273px;" required>
                    </section>
                    
                    <!-- Input Harga -->
                    <section class="form-group d-flex justify-content-between px-3 mt-4">
                        <label for="harga">Harga</label>
                        <input type="number" name="harga" id="harga" class="form-control" style="max-width: 273px;" placeholder="Masukkan harga" required>
                    </section>
                    
                    <!-- Input Terjual -->
                    <section class="form-group d-flex justify-content-between px-3 mt-4">
                        <label for="terjual">Terjual</label>
                        <input type="number" name="terjual" id="terjual" class="form-control" style="max-width: 273px;" placeholder="Masukkan produk terjual" required>
                    </section>
