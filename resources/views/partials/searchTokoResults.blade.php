    ...
    <tr>
        ...
        <td class="d-flex justify-content-center">
            @if(session('level') == 'owner')
                <button class="btn btn-warning btn-sm mx-2" type="button" data-bs-toggle="modal" data-bs-target="#Edittoko"
                    data-id="{{ $toko->id }}"
                    data-name="{{ $toko->name }}"
                ...
                <button class="btn btn-danger btn-sm mx-2 deleteToko" type="button"
